...
export class ExerciseService {
  ...
  const user = this.auth.currentUser;
    ...
    return this.http.get<Exercise[]>(`http://localhost:3000/users/${user.uid}/splits/${splitId}/sessions/${sessionId}/exercises`)
  }
  ...
  postExercise(exerciseName: string, exerciseType: string, indexOrder: number, splitId: string, sessionId: string) : Observable<void> {
    ...
    return this.http.post<void>(`http://localhost:3000/users/${user.uid}/splits/${splitId}/sessions/${sessionId}/exercises`,
  ...
  deleteExercise(splitId: string, sessionId: string, exerciseId: string) : Observable<void> {
    ...
    return this.http.delete<void>(`http://localhost:3000/users/${user.uid}/splits/${splitId}/sessions/${sessionId}/exercises/${exerciseId}`);
  }
  ...
  putExercise(exerciseName: string, exerciseType: string, indexOrder: number, splitId: string, sessionId: string, exerciseId: string): Observable<void> {
    ...
    return this.http.put<void>(`http://localhost:3000/users/${user.uid}/splits/${splitId}/sessions/${sessionId}/exercises/${exerciseId}`, body);
  }
