...
import { addExercise, addExerciseFail, addExerciseSuccess, deleteExercise, deleteExerciseFail,
    ...
    resetUpdatedExerciseState,  resetUpdatedExercisesState,  retrieveExercises, retrieveExercisesFail, retrieveExercisesSuccess,  
    updateExercise, updateExerciseFail, updateExerciseSuccess, updateExercises, updateExercisesFail, updateExercisesSuccess,
...
const reducer = createReducer(initialState,
    ...
    on(updateExercises, currentState => {
        return {
            ...currentState,
            error: null,
            isUpdatedExercises: false,
            isUpdatingExercises: true
        };
    }),
    on(updateExercisesSuccess, currentState => {
        return {
            ...currentState,
            error: null,
            isUpdatedExercises: true,
            isUpdatingExercises: false,
        };
    }),
    on(updateExercisesFail, (currentState, action) => {
        return {
            ...currentState,
            error: action.error,
            isUpdatedExercises: false,
    ...
    on(resetUpdatedExercisesState, currentState => {
        return {
            ...currentState,
            error: null,
            isUpdatedExercises: false
